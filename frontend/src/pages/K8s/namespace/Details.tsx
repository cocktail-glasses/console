...
import { LimitRangeRenderer } from '../limitRange/List.tsx';
import { ResourceQuotaRenderer } from '../resourceQuota/List.tsx';
...
import Namespace, { KubeNamespace } from '@lib/k8s/namespace.ts';
