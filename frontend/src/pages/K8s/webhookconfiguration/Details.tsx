...
import { Link, NameValueTable, SectionBox, SimpleTable } from '@components/common';
import { DetailsGrid, SecretField } from '@components/common/Resource';
import { MatchExpressions } from '@components/common/Resource/MatchExpressions.tsx';
                    ...
                    <NameValueTable
                      ...
                      rows={[
                        ...
                        },
                        {
                          ...
                          value: (webhook as MutatingWebhookConfiguration['webhooks'][number]).reinvocationPolicy,
                          hide: !(webhook as MutatingWebhookConfiguration['webhooks'][number]).reinvocationPolicy,
                        },
                        {
                          name: t('Rules'),
                          value: (
