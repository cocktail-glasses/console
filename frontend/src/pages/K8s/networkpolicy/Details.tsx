...
import { DetailsGrid, metadataStyles, NameValueTable, SectionBox } from '@components/common';
import { matchExpressionSimplifier, matchLabelsSimplifier } from '@lib/k8s';
import { LabelSelector } from '@lib/k8s/cluster.ts';
import NetworkPolicy, {
  NetworkPolicyEgressRule,
  NetworkPolicyIngressRule,
  NetworkPolicyPort,
} from '@lib/k8s/networkpolicy.tsx';
