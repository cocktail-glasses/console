...
import { UsageBarChart } from './Charts.tsx';
import { NodeReadyLabel } from './Details.tsx';
...
import { getResourceMetrics } from '@lib/util.ts';
    ...
    <ResourceListView
      ...
      columns={[
        'name',
        {
          ...
          render: (node) => (
            <UsageBarChart node={node} nodeMetrics={nodeMetrics} resourceType="cpu" noMetrics={noMetrics} />
          ),
        },
        {
          id: 'memory',
          ...
          render: (node) => (
            <UsageBarChart node={node} nodeMetrics={nodeMetrics} resourceType="memory" noMetrics={noMetrics} />
          ),
        },
        {
          id: 'ready',
