...
import { RootState } from './reducers/reducers.tsx';
...
export const listenerMiddleware = createListenerMiddleware<Pick<RootState, 'eventCallbackReducer'>>();
...
export function useEventCallback(eventType: HeadlampEventType.ERROR_BOUNDARY): (error: Error) => void;
...
export function useEventCallback(eventType: HeadlampEventType.LOGS): (data: EventDataType<LogsEvent>) => void;
export function useEventCallback(eventType: HeadlampEventType.TERMINAL): (data: EventDataType<TerminalEvent>) => void;
export function useEventCallback(
...
export function useEventCallback(eventType: HeadlampEventType.PLUGIN_LOADING_ERROR): (plugin: Plugin) => void;
export function useEventCallback(eventType: HeadlampEventType.PLUGINS_LOADED): (plugins: Plugin[]) => void;
export function useEventCallback(
