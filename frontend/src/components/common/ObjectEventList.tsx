...
import { HoverInfoLabel, SectionBox, SimpleTable } from "@components/common/index.ts";
import ShowHideLabel from "@components/common/ShowHideLabel";
import { KubeObject } from "@lib/k8s/cluster.ts";
import Event, { KubeEvent } from "@lib/k8s/event.ts";
import { localeDate, timeAgo } from "@lib/util.ts";
