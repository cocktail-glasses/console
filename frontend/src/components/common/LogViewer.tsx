    ...
    <Dialog title={title} withFullScreen onClose={onClose} {...other}>
      ...
      >
        <Grid container justifyContent="space-between" alignItems="center" wrap="nowrap">
          ...
          <Grid item xs>
            <ActionButton description={t('Download')} onClick={downloadLog} icon="mdi:file-download-outline" />
          </Grid>
        </Grid>
        <Box
          sx={(theme) => ({
        ...
        >
          ...
          />
          <SearchPopover open={showSearch} onClose={() => setShowSearch(false)} searchAddonRef={searchAddonRef} />
        </Box>
      </DialogContent>
    </Dialog>
  );
