...
import { PercentageCircleProps } from '@components/common/Chart.tsx';
import TileChart from '@components/common/TileChart';
import { KubeMetrics, KubeObject } from '@lib/k8s/cluster.ts';
...
export function CircularChart(props: CircularChartProps) {
  ...
  function getResourceUsage() {
    ...
    const usedValue = sumBy(nodeMetrics, resourceUsedGetter);
    const availableValue = sumBy(items, resourceAvailableGetter);
