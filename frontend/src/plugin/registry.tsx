...
// import { AppLogoProps, AppLogoType } from '@lib/App/AppLogo';
// import { runCommand } from '@lib/App/runCommand';
// import { DefaultSidebars, SidebarEntryProps } from '@lib/Layout/Sidebar';
// import { KubeObject } from '@lib/k8s/cluster';
// import { Route } from '@lib/router';
// import { ClusterChooserProps, ClusterChooserType } from '@pages/K8s/cluster/ClusterChooser';
// import {
//   AppBarAction,
...
// // import { setClusterChooserButtonComponent } from 'redux/actions/actions';
// import {
//   addDetailsViewSectionsProcessor,
//   DefaultDetailsViewSection,
//   DetailsViewSectionsProcessor,
//   setDetailsViewSection,
// } from 'redux/detailsViewSectionSlice';
// import {
//   addEventCallback,
//   CreateResourceEvent,
//   DeleteResourceEvent,
...
//   PluginSettingsDetailsProps, // setPluginSettingsComponent,
// } from 'redux/pluginsSlice';
// import { setRoute, setRouteFilter } from 'redux/routesSlice';
// import { setSidebarItem, setSidebarItemFilter } from 'redux/sidebarSlice';
// import store from 'redux/stores/store';
// import { setBrandingAppLogoComponent } from 'redux/themeSlice';
...
//    */
//   registerDetailsViewHeaderAction(_actionName: string, actionFunc: HeaderActionType) {
...
//    */
//   registerAppBarAction(_actionName: string, actionFunc: (...args: any[]) => JSX.Element | null) {
...
//    * ```
//    */
//   registerDetailsViewSection(sectionName: string, sectionFunc: (props: { resource: any }) => SectionFuncProps | null) {
...
//  * ```
//  */
// export function registerSidebarEntryFilter(filterFunc: (entry: SidebarEntryProps) => SidebarEntryProps | null) {
...
//   return !!(
//     headerAction &&
//     (has(headerAction, 'processor') || (typeof headerAction === 'function' && headerAction.length === 1))
//   );
// }
