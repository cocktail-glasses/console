...
import { collapseGraph, findGroupContaining, getGraphSize, GroupBy, groupGraph } from './graph/graphGrouping';
...
import { NamespacesAutocomplete } from '@components/common';
...
function GraphViewContent({
  ...
  const [selectedNodeId, _setSelectedNodeId] = useQueryParamsState<string | undefined>('node', defaultNodeSelection);
  ...
  const maybeSelectedNode = selectedNodeId ? fullGraphContext.lookup.getNode(selectedNodeId) : undefined;
      ...
      <FullGraphContext.Provider value={fullGraphContext}>
        ...
        >
          <CustomThemeProvider>
            ...
            >
              <Box padding={2} pb={0} display="flex" gap={1} alignItems="center" mb={1} flexWrap="wrap">
