...
import { AuthVisible } from '@components/common/Resource';
...
export default function CreateNamespaceButton() {
  ...
  return (
    <AuthVisible item={Namespace} authVerb="create">
      ...
      <Dialog aria-label="Dialog" open={namespaceDialogOpen} onClose={() => setNamespaceDialogOpen(false)}>
        ...
        <DialogContent>
          <Box component="form" style={{ width: '20vw', maxWidth: '20vw' }}>
            <TextField
              ...
              helperText={!isValidNamespaceName && namespaceName.length > 0 ? nameHelperMessage : ''}
              fullWidth
              value={namespaceName}
