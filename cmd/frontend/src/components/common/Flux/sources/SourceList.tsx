...
export function FluxSources() {
  return (
    <>
      <FluxSource resourceClass={gitRepositoryClass()} pluralName="gitrepositories" title={'Git Repositories'} />
      <FluxSource resourceClass={ociRepositoryClass()} pluralName="ocirepositories" title={'OCI Repositories'} />
      <FluxSource resourceClass={bucketRepositoryClass()} pluralName="buckets" title={'Buckets'} />
      <FluxSource resourceClass={helmRepositoryClass()} pluralName="helmrepositories" title={'Helm Repositories'} />
