...
import { ConditionsTable, Link, MainInfoSection, SectionBox } from '@components/common';
...
function KustomizationDetails(props) {
  ...
  function prepareExtraInfo(cr) {
    ...
    const { name: sourceName, pluralKind: sourceType, namespace: sourceNamespace } = getSourceNameAndPluralKind(cr);
    const extraInfo = [
      {
        name: 'Status',
