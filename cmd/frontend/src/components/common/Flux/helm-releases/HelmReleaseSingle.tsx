...
import { HelmInventory } from './Inveltory';

import { ConditionsTable, Link, MainInfoSection, SectionBox, Table } from '@components/common';
...
function CustomResourceDetails(props) {
  ...
  return (
    <>
      ...
      {cr && <MainInfoSection resource={cr} extraInfo={prepareExtraInfo(cr)} actions={prepareActions()} />}
