          ...
          patch(
            ...
            .then((response) => {
              if (response.spec.suspend) {
                enqueueSnackbar(`Successfully suspended reconciliation for ${resource.metadata.name}`, {
                  variant: 'success',
                });
              } else {
            ...
            .catch((error) => {
              enqueueSnackbar(`Failed to suspend reconciliation for ${resource.metadata.name} error ${error}`, {
                variant: 'error',
              });
            });
        }}
    ...
    <ActionButton
      ...
      onClick={() => {
        ...
        patch(
          ...
          .catch((error) => {
            enqueueSnackbar(`Failed to resume reconciliation for ${resource.metadata.name} error ${error}`, {
              variant: 'error',
            });
          });
      }}
