      ...
      <Table
        ...
        columns={[
          ...
          },
          {
            ...
            accessorFn: (item) =>
              item?.jsonData.spec?.eventSources.map((source) => `${source.kind}/${source.name}`).join(', '),
          },
          {
            header: 'Summary',
      ...
      <Table
        ...
        columns={[
          ...
          },
          {
            ...
            accessorFn: (item) =>
              (item.jsonData.spec.certSecretRef && JSON.stringify(item.jsonData.spec.certSecretRef)) || '-',
          },
          {
            header: 'Interval',
        ...
        columns={[
          ...
          },
          {
            ...
            accessorFn: (item) =>
              ...
              item.jsonData.spec.resources.map((obj) => <Box>{JSON.stringify(obj).replace(/"/g, '')}</Box>),
          },
          {
            header: 'Secret Ref',
            accessorFn: (item) =>
