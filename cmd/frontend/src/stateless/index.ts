...
//         clusterToCompare = cloneDeep(clusters[key]);
//         delete clusterToCompare.useToken;
//       }

//       if (isStateless) {
//         if (isEqual(clustersToConfig[key], clusterToCompare)) {
//           delete clusters[key];
//         }
//       } else {
//         isConfigDifferent =
//           isConfigDifferent || !isEqual(clustersToConfig[key], clusterToCompare);
//       }
//     }
//   });
