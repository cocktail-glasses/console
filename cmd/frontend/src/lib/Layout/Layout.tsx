...
// import RouteSwitcher from '@lib/App/RouteSwitcher';
...
//           <TopBar />
//           <Sidebar />
//           <Main id="main" sx={{ flexGrow: 1, marginLeft: 'initial', overflow: 'hidden', width: '100vw', height: '100vh' }}>
//             {allClusters &&
//               !!clusterInURL &&
//               !Object.keys(allClusters).includes(getCluster() || '') ? (<ClusterNotFoundPopup />) : ('')
//             }
//             <AlertNotification />
//             <Box>
