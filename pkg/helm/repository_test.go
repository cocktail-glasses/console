...
func newHelmHandler(t *testing.T) *Handler {
	t.Helper()
...
func checkRepoExists(t *testing.T, helmHandler *Handler, repoName string) bool {
	t.Helper()
	...
	var listRepoResponse ListRepoResponse
...
//nolint:unparam
func testAddRepo(t *testing.T, helmHandler *Handler, repoName, repoURL string) {
	t.Helper()

	// add headlmap repo
	addRepo := AddUpdateRepoRequest{
...
func TestUpdateRepo(t *testing.T) {
	...
	t.Run("update_repo_success", func(t *testing.T) {
		...
		updateRepo := AddUpdateRepoRequest{
			Name: "headlamp_test_repo",
