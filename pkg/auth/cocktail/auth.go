...
func (a *CocktailAuthenticator) Authenticate(w http.ResponseWriter, r *http.Request) (*auth.User, error) {
	ls, err := a.sessions.GetSession(w, r)
	if err != nil {
		return nil, err
	}
	return ls, nil
...
func (a *CocktailAuthenticator) CallbackFunc(fn func(loginInfo sessions.LoginJSON, successURL string, w http.ResponseWriter)) func(w http.ResponseWriter, req *http.Request) {
...
func (a *CocktailAuthenticator) LogoutRedirectURL() string            { return "" }
func (a *CocktailAuthenticator) GetSpecialURLs() auth.SpecialAuthURLs { return auth.SpecialAuthURLs{} }
func (a *CocktailAuthenticator) IsStatic() bool                       { return true }
