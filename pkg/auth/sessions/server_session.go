...
import (
	...
	consoleUtils "github.com/cocktailcloud/console/pkg/utils"
	"golang.org/x/oauth2"
...
const (
	CocktailSessionTokenCookieName = "cocktail-session-token"
	cocktailRefreshTokenCookieName = "cocktail-refresh-token"
)
