...
// cocktailCloudAuth implements OpenShift Authentication as defined in:
...
func (o *cocktailCloudAuth) getOIDCDiscovery() *oidcDiscovery {
	return o.oauthEndpointCache.GetItem()
}

func (o *cocktailCloudAuth) getOIDCDiscoveryInternal(ctx context.Context) (*oidcDiscovery, error) {
...
func (o *cocktailCloudAuth) login(w http.ResponseWriter, _ *http.Request, token *oauth2.Token) (*sessions.LoginState, error) {
...
func (o *cocktailCloudAuth) DeleteCookie(w http.ResponseWriter, r *http.Request) {
...
func (o *cocktailCloudAuth) logout(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
...
func (o *cocktailCloudAuth) LogoutRedirectURL() string {
	return o.logoutRedirectOverride
}

func (o *cocktailCloudAuth) reviewToken(token string) (*authv1.TokenReview, error) {
...
func (o *cocktailCloudAuth) Authenticate(_ http.ResponseWriter, r *http.Request) (*auth.User, error) {
	cookie, err := r.Cookie(sessions.OpenshiftAccessTokenCookieName)
	if err != nil {
		return nil, err
	}
...
func (o *cocktailCloudAuth) GetSpecialURLs() auth.SpecialAuthURLs {
...
func (o *cocktailCloudAuth) oauth2Config() *oauth2.Config {
