...
func flagset() *flag.FlagSet {
	...
	f.Bool("enable-dynamic-clusters", true, "Enable dynamic clusters, which stores stateless clusters in the frontend.")
	...
	f.String("base-url", "/headlamp", "Base URL path. eg. /headlamp")
